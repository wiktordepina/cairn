...
def redact_secrets(text: str) -> str:
    ...
    Thin alias over `cairn._redaction_patterns.redact_text` — kept as a
    public entrypoint so the tool-output redactor and the log redactor
    use the same patterns without one having to import from the
    other's module.
    """
